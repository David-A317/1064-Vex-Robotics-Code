...
motor intakeTop(PORT4, ratio6_1, true);
motor intake(PORT2, ratio6_1, true);
motor intakeBottom(PORT20, ratio6_1, true);

motor rf(PORT11, ratio6_1, false);
motor rm(PORT14, ratio6_1, true);
motor rb(PORT16, ratio6_1, false);
motor lf(PORT15, ratio6_1, true);
motor lm(PORT18, ratio6_1, true);
motor lb(PORT19, ratio6_1, false);
...
digital_out ramp(Brain.ThreeWirePort.A);
digital_out schlorb(Brain.ThreeWirePort.B);
